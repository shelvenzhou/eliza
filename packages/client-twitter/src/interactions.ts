...
Here is the current post text again. The total character count MUST be less than 280. Remember to include an action if the current post text includes a prompt that asks for one of the available actions mentioned above (does not need to be exact)
{{currentPost}}
